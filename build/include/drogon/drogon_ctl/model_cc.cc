...
model_cc_tmp_stream<<alias;
	model_cc_tmp_stream << "(const drogon::orm::DbClientPtr &clientPtr) const {\n";
	model_cc_tmp_stream << "    std::shared_ptr<std::promise<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ">> pro(new std::promise<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ">);\n";
	model_cc_tmp_stream << "    std::future<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << "> f = pro->get_future();\n";
	model_cc_tmp_stream << "    get";
model_cc_tmp_stream<<alias;
	model_cc_tmp_stream << "(clientPtr, [&pro] (";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << " result) {\n";
	model_cc_tmp_stream << "        try {\n";
	model_cc_tmp_stream << "            pro->set_value(result);\n";
	model_cc_tmp_stream << "        }\n";
	model_cc_tmp_stream << "        catch (...) {\n";
	model_cc_tmp_stream << "            pro->set_exception(std::current_exception());\n";
	model_cc_tmp_stream << "        }\n";
	model_cc_tmp_stream << "    }, [&pro] (const DrogonDbException &err) {\n";
	model_cc_tmp_stream << "        pro->set_exception(std::make_exception_ptr(err));\n";
	model_cc_tmp_stream << "    });\n";
	model_cc_tmp_stream << "    return f.get();\n";
	model_cc_tmp_stream << "}\n";
	model_cc_tmp_stream << "void ";
{
    auto & val=model_cc_view_data["className"];
...
model_cc_tmp_stream<<alias;
	model_cc_tmp_stream << "(const drogon::orm::DbClientPtr &clientPtr) const {\n";
	model_cc_tmp_stream << "    std::shared_ptr<std::promise<std::vector<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ">>> pro(new std::promise<std::vector<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ">>);\n";
	model_cc_tmp_stream << "    std::future<std::vector<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ">> f = pro->get_future();\n";
	model_cc_tmp_stream << "    get";
model_cc_tmp_stream<<alias;
	model_cc_tmp_stream << "(clientPtr, [&pro] (std::vector<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << "> result) {\n";
	model_cc_tmp_stream << "        try {\n";
	model_cc_tmp_stream << "            pro->set_value(result);\n";
...
model_cc_tmp_stream<<alias;
	model_cc_tmp_stream << "(const drogon::orm::DbClientPtr &clientPtr) const {\n";
	model_cc_tmp_stream << "    std::shared_ptr<std::promise<std::vector<std::pair<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ",";
model_cc_tmp_stream<<pivotTableClassName;
	model_cc_tmp_stream << ">>>> pro(new std::promise<std::vector<std::pair<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ",";
model_cc_tmp_stream<<pivotTableClassName;
	model_cc_tmp_stream << ">>>);\n";
	model_cc_tmp_stream << "    std::future<std::vector<std::pair<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ",";
model_cc_tmp_stream<<pivotTableClassName;
	model_cc_tmp_stream << ">>> f = pro->get_future();\n";
	model_cc_tmp_stream << "    get";
model_cc_tmp_stream<<alias;
	model_cc_tmp_stream << "(clientPtr, [&pro] (std::vector<std::pair<";
model_cc_tmp_stream<<relationshipClassName;
	model_cc_tmp_stream << ",";
model_cc_tmp_stream<<pivotTableClassName;
	model_cc_tmp_stream << ">> result) {\n";
