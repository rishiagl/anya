...
std::string config::genText(const DrTemplateData& config_view_data)
{
	...
	config_tmp_stream << "        \"cert\": \"../../trantor/trantor/tests/server.crt\",\n";
	config_tmp_stream << "        \"key\": \"../../trantor/trantor/tests/server.key\",\n";
	...
	config_tmp_stream << "            \"svg\",\n";
	config_tmp_stream << "            \"webp\"\n";
	config_tmp_stream << "        ],\n";
